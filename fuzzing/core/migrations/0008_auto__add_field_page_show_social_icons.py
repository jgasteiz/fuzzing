...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.show_social_icons'
        db.add_column(u'core_page', 'show_social_icons',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.show_social_icons'
        db.delete_column(u'core_page', 'show_social_icons')

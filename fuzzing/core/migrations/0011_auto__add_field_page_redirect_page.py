...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_page', 'redirect_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='redirect', null=True, to=orm['core.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.redirect_page'
        db.delete_column(u'core_page', 'redirect_page_id')

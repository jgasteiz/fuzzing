...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.slug_en'
        db.add_column(u'core_page', 'slug_en',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.slug_es'
        db.add_column(u'core_page', 'slug_es',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.slug_eu'
        db.add_column(u'core_page', 'slug_eu',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Page.slug_en'
        db.delete_column(u'core_page', 'slug_en')

        # Deleting field 'Page.slug_es'
        db.delete_column(u'core_page', 'slug_es')

        # Deleting field 'Page.slug_eu'
        db.delete_column(u'core_page', 'slug_eu')
    ...
    models = {
        ...
        u'core.page': {
            ...
            'slug_es': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'slug_eu': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),

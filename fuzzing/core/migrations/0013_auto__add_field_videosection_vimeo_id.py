...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoSection.vimeo_id'
        db.add_column(u'core_videosection', 'vimeo_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoSection.vimeo_id'
        db.delete_column(u'core_videosection', 'vimeo_id')

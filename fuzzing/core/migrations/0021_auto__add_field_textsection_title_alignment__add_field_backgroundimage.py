...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextSection.title_alignment'
        db.add_column(u'core_textsection', 'title_alignment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'BackgroundImageTextSection.title_alignment'
        db.add_column(u'core_backgroundimagetextsection', 'title_alignment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextSection.title_alignment'
        db.delete_column(u'core_textsection', 'title_alignment')

        # Deleting field 'BackgroundImageTextSection.title_alignment'
        db.delete_column(u'core_backgroundimagetextsection', 'title_alignment')
    ...
    models = {
        u'core.backgroundimagetextsection': {
            ...
            'title_alignment': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),

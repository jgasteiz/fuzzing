...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_videosection', (
            ...
            ('youtube_id', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('height', self.gf('django.db.models.fields.CharField')(default='360px', max_length=256, blank=True)),
            ('width', self.gf('django.db.models.fields.CharField')(default='100%', max_length=256, blank=True)),
        ))
        db.send_create_signal(u'core', ['VideoSection'])


    def backwards(self, orm):
        # Deleting model 'VideoSection'
        db.delete_table(u'core_videosection')

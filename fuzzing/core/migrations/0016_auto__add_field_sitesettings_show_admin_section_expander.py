...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.show_admin_section_expander'
        db.add_column(u'core_sitesettings', 'show_admin_section_expander',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteSettings.show_admin_section_expander'
        db.delete_column(u'core_sitesettings', 'show_admin_section_expander')
    ...
    models = {
        ...
        u'core.sitesettings': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'show_admin_section_expander': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),

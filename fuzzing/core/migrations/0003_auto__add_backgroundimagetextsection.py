...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BackgroundImageTextSection'
        db.create_table(u'core_backgroundimagetextsection', (
            ...
            ('text_side', self.gf('django.db.models.fields.CharField')(default='left', max_length=64)),
            ('background_position', self.gf('django.db.models.fields.CharField')(default='center', max_length=64)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Page'], null=True)),
        ))
        db.send_create_signal(u'core', ['BackgroundImageTextSection'])


    def backwards(self, orm):
        # Deleting model 'BackgroundImageTextSection'
        db.delete_table(u'core_backgroundimagetextsection')

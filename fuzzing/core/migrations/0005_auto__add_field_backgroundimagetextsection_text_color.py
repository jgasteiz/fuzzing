...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BackgroundImageTextSection.text_color'
        db.add_column(u'core_backgroundimagetextsection', 'text_color',
                      self.gf('django.db.models.fields.CharField')(default='#000000', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BackgroundImageTextSection.text_color'
        db.delete_column(u'core_backgroundimagetextsection', 'text_color')
